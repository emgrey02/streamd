...
import { deleteList, getLists } from '@/app/actions/lists';
import Image from 'next/image';
import { useRouter } from 'next/navigation';
import NewListForm from '@/app/components/Dashboard/NewListForm';
...
export default function Lists({ accessToken, accountObjectId }: Props) {
    ...
    useEffect(() => {
        async function getThoseLists() {
            if (accountObjectId) {
                const lists = await getLists(accountObjectId, 1);
